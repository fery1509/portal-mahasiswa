  ...
  return (
    <div className="animate-fade-in">
      <div className="pb-5 border-b border-gray-200">
        <h3 className="text-2xl font-bold leading-6 text-gray-900">Presensi Kuliah</h3>
      </div>

      {/* Overall statistics */}
      <div className="mt-6 bg-white shadow rounded-lg overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Statistik Kehadiran</h3>
        </div>
        <div className="p-5">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center">
              <div className="mr-4">
                ...
                <div className="text-sm text-gray-500">Kehadiran Keseluruhan</div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 md:mt-0">
              <div className="text-center">
                <div className="text-xl font-semibold text-gray-900">{stats.totalSessions}</div>
                <div className="text-sm text-gray-500">Total Pertemuan</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-semibold text-green-600">{stats.presentCount}</div>
                <div className="text-sm text-gray-500">Hadir</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-semibold text-red-600">{stats.absentCount}</div>
                <div className="text-sm text-gray-500">Tidak Hadir</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-semibold text-amber-600">{stats.lateCount}</div>
        ...
        {filteredCourses.length > 0 ? (
          filteredCourses.map((course) => {
            ...
            const filteredAttendances = statusFilter === 'all' 
              ? attendances 
              : attendances.filter(attendance => attendance.status === statusFilter);
                              ...
                              <tr key={attendance.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <div className="flex items-center">
                                    ...
                                    <span 
                                      className={`ml-2 inline-flex text-xs font-medium px-2.5 py-0.5 rounded-full ${statusMap[attendance.status].color}`}
                                    >

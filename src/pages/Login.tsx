        ...
        <div className="w-full max-w-md space-y-8 p-8 rounded-xl backdrop-blur-md bg-white/30 shadow-xl border border-white/30">
          ...
          <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-3 px-4 border border-white/30 rounded-lg text-sm font-semibold text-white bg-white/20 hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50 backdrop-blur-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >

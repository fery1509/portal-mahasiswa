...
import { Users, Book, Calendar, UserPlus, ChevronUp, ChevronDown, CheckCircle, Search } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const getActionDetails = (action: string) => {
    switch (action) {
      case 'add_student':
        return { icon: <UserPlus className="h-5 w-5 text-green-500" />, color: 'bg-green-100 text-green-800' };
      case 'update_course':
        return { icon: <Book className="h-5 w-5 text-blue-500" />, color: 'bg-blue-100 text-blue-800' };
      case 'approve_registration':
        return { icon: <CheckCircle className="h-5 w-5 text-purple-500" />, color: 'bg-purple-100 text-purple-800' };
      case 'add_course':
        return { icon: <Book className="h-5 w-5 text-green-500" />, color: 'bg-green-100 text-green-800' };
      default:
  ...
  return (
    <div className="animate-fade-in">
      <div className="pb-5 border-b border-gray-200">
        <h3 className="text-2xl font-bold leading-6 text-gray-900">Dashboard Admin Akademik</h3>
      </div>
      ...
      <div className="mt-6 rounded-lg bg-gradient-to-r from-kampus-primary to-kampus-secondary p-6 shadow-md text-white">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1">Admin Akademik</p>
          </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white overflow-hidden shadow rounded-lg hover-scale">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/students" className="font-medium text-kampus-primary hover:text-kampus-accent">
                Lihat detail
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg hover-scale">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/courses" className="font-medium text-kampus-primary hover:text-kampus-accent">
                Lihat detail
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg hover-scale">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/faculty" className="font-medium text-kampus-primary hover:text-kampus-accent">
                Lihat detail
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg hover-scale">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link to="/admin/students?status=active" className="font-medium text-kampus-primary hover:text-kampus-accent">
                Lihat detail
              </Link>
            </div>
          </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-3">
        <div className="bg-white shadow rounded-lg lg:col-span-2">
          <div className="px-5 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Mahasiswa Terbaru</h3>
            <div className="flex items-center">
                  ...
                  {recentStudents.map((student) => (
                    <tr key={student.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="#" className="text-kampus-primary hover:text-kampus-accent">
                          Detail
                        </a>
                      </td>
                    </tr>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-gray-900">
                            {action.user} {action.action === 'add_student' 

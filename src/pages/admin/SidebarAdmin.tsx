    ...
    <div className="h-full flex flex-col bg-gradient-to-b from-indigo-900 to-indigo-800 text-white">
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-indigo-700/50">
        <Link to="/admin/dashboard" className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold bg-gradient-to-r from-white to-indigo-200 bg-clip-text text-transparent">SIMAK Admin</span>
        </Link>
      </div>
      {/* User info */}
      ...
      <div className="p-4 border-t border-indigo-700/50">
        <button
          ...
          className="flex items-center w-full px-3 py-2.5 text-sm font-medium text-indigo-100 rounded-lg hover:bg-red-500/20 hover:text-red-200 transition-all duration-200"
        >
